...
// Receive the envoy_config_rbac_v2.Policy input and convert it to mosn rbac policy
func NewInheritPolicy(policy *envoy_config_rbac_v2.Policy) (*InheritPolicy, error) {
